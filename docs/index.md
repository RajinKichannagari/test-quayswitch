...
!!! info
    ...
    **Source Code Repository:** [https://github.com/RajinKichannagari/test-quayswitch](https://github.com/RajinKichannagari/test-quayswitch)

    **GitOps Repository:** [https://github.com/RajinKichannagari/test-quayswitch-gitops](https://github.com/RajinKichannagari/test-quayswitch-gitops)

# **Usage**

To access the test-quayswitch application that was deployed using the Software Template, complete the following instructions:
